  ...
  <div>
    ...
    <el-form inline :model="form">
      ...
      <el-form-item label="一级分类">
        ...
        <el-select v-model="form.category1Id" placeholder="请选择" @change="changeCategory1Handle">
      ...
      <el-form-item label="二级分类">
        <!--下拉框中选中的数据会绑定到该对象的某个属性上-->
        <el-select v-model="form.category2Id" placeholder="请选择" @change="changeCategory2Handle">
          <!--遍历出来的数据，label:存储的是用户可以看得到的数据,value:中存储的是选中后看到的这个数据对应的id值-->
          <el-option
      ...
      <el-form-item label="三级分类">
        <!--下拉框中选中的数据会绑定到该对象的某个属性上-->
        <el-select v-model="form.category3Id" placeholder="请选择" @change="changeCategory3Handle">
          <!--遍历出来的数据，label:存储的是用户可以看得到的数据,value:中存储的是选中后看到的这个数据对应的id值-->
          <el-option
